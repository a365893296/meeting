  ...
  <el-row align="middle" >
    ...
    <el-col :xs="4" :sm="4" :md="8" :lg="8">&nbsp</el-col>
     ...
     <el-col :xs="16" :sm="16" :md="8" :lg="8" class="form">
        ...
        <el-form :model="loginForm" :rules="rules" ref="loginForm"  label-width="90px" class="demo-loginForm">
          ...
          <el-form-item label="密码" prop="password" >
            <el-input v-model="loginForm.password" type="password" v-on:keyup.enter.native="login(loginForm)"></el-input>
          </el-form-item>
